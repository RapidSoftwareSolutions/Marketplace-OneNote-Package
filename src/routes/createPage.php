...
$app->post('/api/OneNote/createPage', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken','content']);
    ...
    $requiredParams = ['accessToken'=>'accessToken','content'=>'content'];
    $optionalParams = [];
    $bodyParams = [
       'body' => ['content']
    ];
